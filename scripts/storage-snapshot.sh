...
contracts=(
  ...
  contracts/L1/PatexPortal.sol:PatexPortal
  ...
  contracts/universal/PatexMintableERC20.sol:PatexMintableERC20
  contracts/universal/PatexMintableERC20Factory.sol:PatexMintableERC20Factory
)
