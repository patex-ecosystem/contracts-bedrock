...
contract PostSherlockL2 is Script {
    ...
    /**
     * @notice PATEX Mainnet chain id.
     */
    uint256 constant OP_MAINNET = 10;

    /**
     * @notice PATEX Goerli chain id.
     */
    ...
    struct ContractSet {
        ...
        address PatexMintableERC20Factory;
        address PatexMintableERC721Factory;
    }
    ...
    string constant internal PatexMintableERC20Factory_Version = "1.1.0";
    string constant internal PatexMintableERC721Factory_Version = "1.1.0";
    ...
    function setUp() external {
        implementations[OP_GOERLI] = ContractSet({
            ...
            PatexMintableERC20Factory: 0xeDF90ac13642e6445955b79CdDA321ecB136b29B,
            PatexMintableERC721Factory: 0x795F355F75f9B28AEC6cC6A887704191e630065b
        });
        ...
        proxies[OP_GOERLI] = ContractSet({
            ...
            PatexMintableERC20Factory: Predeploys.PATEX_MINTABLE_ERC20_FACTORY,
            PatexMintableERC721Factory: Predeploys.PATEX_MINTABLE_ERC721_FACTORY
        });
    }
    ...
    function _postCheck() internal view {
        ...
        require(_versionHash(prox.PatexMintableERC20Factory) == keccak256(bytes(PatexMintableERC20Factory_Version)));
        require(_versionHash(prox.PatexMintableERC721Factory) == keccak256(bytes(PatexMintableERC721Factory_Version)));
        ...
        require(PROXY_ADMIN.getProxyImplementation(prox.PatexMintableERC20Factory).codehash == impl.PatexMintableERC20Factory.codehash);
        require(PROXY_ADMIN.getProxyImplementation(prox.PatexMintableERC721Factory).codehash == impl.PatexMintableERC721Factory.codehash);
    }
    ...
    function buildCalldata(address _proxyAdmin) internal view returns (bytes memory) {
        ...
        // Upgrade the PatexMintableERC20Factory
        calls[9] = IMulticall3.Call3({
            target: _proxyAdmin,
            allowFailure: false,
            callData: abi.encodeCall(
                ProxyAdmin.upgrade,
                (payable(prox.PatexMintableERC20Factory), impl.PatexMintableERC20Factory)
            )
        });

        // Upgrade the PatexMintableERC721Factory
        calls[10] = IMulticall3.Call3({
            target: _proxyAdmin,
            allowFailure: false,
            callData: abi.encodeCall(
                ProxyAdmin.upgrade,
                (payable(prox.PatexMintableERC721Factory), impl.PatexMintableERC721Factory)
            )
        });
