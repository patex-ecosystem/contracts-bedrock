...
contract PostSherlock is Script {
    ...
    string constant internal PatexPortal_Version = "1.3.1";
    ...
    function setUp() external {
        implementations[GOERLI] = ContractSet({
            ...
            PatexMintableERC20Factory: 0xF516Fa87f89E4AC7C299aE28263e9EB851dE4781,
            PatexPortal: 0xa24A444C6ceeb1d4Fc19D1B78913C22B9d03BbC9,
        ...
        proxies[GOERLI] = ContractSet({
            ...
            PatexMintableERC20Factory: 0x883dcF8B05364083D849D8bD226bC8Cb4c42F9C5,
            PatexPortal: 0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383,
    ...
    function _postCheck() internal view {
        ...
        require(_versionHash(prox.PatexPortal) == keccak256(bytes(PatexPortal_Version)));
    ...
    function buildCalldata(address _proxyAdmin) internal view returns (bytes memory) {
        ...
        // Upgrade the PatexPortal
        calls[4] = IMulticall3.Call3({
            target: _proxyAdmin,
            allowFailure: false,
            callData: abi.encodeCall(
                ProxyAdmin.upgrade,
                (payable(prox.PatexPortal), impl.PatexPortal)
            )
        });
