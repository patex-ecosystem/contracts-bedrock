...
const deployFn: DeployFunction = async (hre) => {
  ...
  const config = {
    ...
    proxyAddressConfig: {
      ...
      patexPortalProxy: await getDeploymentAddress(
        hre,
        'PatexPortalProxy'
      ),
      l1CrossDomainMessengerProxy: await getDeploymentAddress(
        hre,
        'Proxy__PVM_L1CrossDomainMessenger'
      ),
      l1StandardBridgeProxy: await getDeploymentAddress(
        hre,
        'Proxy__PVM_L1StandardBridge'
      ),
      patexMintableERC20FactoryProxy: await getDeploymentAddress(
        hre,
    ...
    implementationAddressConfig: {
      ...
      patexPortalImpl: await getDeploymentAddress(hre, 'PatexPortal'),
      ...
      patexMintableERC20FactoryImpl: await getDeploymentAddress(
        hre,
