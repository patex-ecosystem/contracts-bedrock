...
contract RelayActor is StdUtils {
    ...
    function relay(
        ...
        // Act as the patex portal and call `relayMessage` on the `L1CrossDomainMessenger` with
...
contract XDM_MinGasLimits is Messenger_Initializer {
    ...
    function setUp() public virtual override {
        // Set up the `L1CrossDomainMessenger` and `PatexPortal` contracts.
        super.setUp();
     ...
     *
     * - The outer min gas limit is for the call from the `PatexPortal` to the
