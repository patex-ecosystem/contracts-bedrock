...
import { PatexMintableERC20Factory } from "../universal/PatexMintableERC20Factory.sol";
...
contract Portal_Initializer is L2OutputOracle_Initializer {
    // Test target
    PatexPortal internal opImpl;
    PatexPortal internal op;
    ...
    function setUp() public virtual override {
        ...
        proxy.upgradeToAndCall(
            address(opImpl),
            abi.encodeWithSelector(PatexPortal.initialize.selector, false)
        );
        op = PatexPortal(payable(address(proxy)));
        vm.label(address(op), "PatexPortal");
    }
}
...
contract Messenger_Initializer is Portal_Initializer {
    ...
    function setUp() public virtual override {
        ...
        vm.prank(multisig);
        addressManager.setAddress("PVM_L1CrossDomainMessenger", address(L1MessengerImpl));
        ResolvedDelegateProxy proxy = new ResolvedDelegateProxy(
            addressManager,
            "PVM_L1CrossDomainMessenger"
        );
...
contract Bridge_Initializer is Messenger_Initializer {
    ...
    PatexMintableERC20Factory L2TokenFactory;
    PatexMintableERC20Factory L1TokenFactory;
    ERC20 L1Token;
    ERC20 BadL1Token;
    PatexMintableERC20 L2Token;
    LegacyMintableERC20 LegacyL2Token;
    ERC20 NativeL2Token;
    ERC20 BadL2Token;
    PatexMintableERC20 RemoteL1Token;
    ...
    function setUp() public virtual override {
        ...
        vm.label(Predeploys.PATEX_MINTABLE_ERC20_FACTORY, "PatexMintableERC20Factory");
        ...
        PatexMintableERC20Factory factory = new PatexMintableERC20Factory(
            Predeploys.L2_STANDARD_BRIDGE
        );
        vm.etch(Predeploys.PATEX_MINTABLE_ERC20_FACTORY, address(factory).code);
        L2TokenFactory = PatexMintableERC20Factory(Predeploys.PATEX_MINTABLE_ERC20_FACTORY);
        ...
        L1TokenFactory = new PatexMintableERC20Factory(address(L1Bridge));

        RemoteL1Token = PatexMintableERC20(
