...
import {
    ...
    IPatexMintableERC20
} from "../universal/IPatexMintableERC20.sol";
import { IERC165 } from "@openzeppelin/contracts/utils/introspection/IERC165.sol";

contract PatexMintableERC20_Test is Bridge_Initializer {
    ...
    function test_mint_notBridge_reverts() external {
        // NOT the bridge
        vm.expectRevert("PatexMintableERC20: only bridge can mint and burn");
    ...
    function test_erc165_supportsInterface_succeeds() external {
        ...
        assertEq(iface3, type(IPatexMintableERC20).interfaceId);
