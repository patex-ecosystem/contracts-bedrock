 ...
 */
contract LegacyERC20ETH is PatexMintableERC20 {
    /**
     * @notice Initializes the contract as an Patex Mintable ERC20.
     */
    constructor()
        PatexMintableERC20(Predeploys.L2_STANDARD_BRIDGE, address(0), "Ether", "ETH")
    {}
