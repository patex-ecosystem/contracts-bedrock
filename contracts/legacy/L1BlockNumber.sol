 ...
 * @title L1BlockNumber
 * @notice L1BlockNumber is a legacy contract that fills the roll of the PVM_L1BlockNumber contract
 *         in the old version of the Patex system. Only necessary for backwards compatibility.
